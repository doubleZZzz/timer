<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		...
		<ul class="in">
			...
			<li name="iplog_list"><a href="/iplog_list">登录记录</a></li>
			<li name="userInfo"><a href="/basicInfo"> <span>个人资料</span></a></li>
		</ul>
	</li>
    <li class="list-group-item">
        <a href="#"><span>债权转让</span></a>
        <ul class="in">
            <li name="listCanTransferCredit"><a href="/listCanTransferCredit">债权转让操作</a></li>
        </ul>
    </li>
	<li class="list-group-item">
...
<#if loginfo??>
    <script>
		...
		<#--使用id来添加选中属性,
			...
			$("[name=${currentNav}]").addClass("active")
        });
	</script>
</#if>
